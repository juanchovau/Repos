          ...
          <CardDeck className="mt-4">
            <Col xs={4}>
              <Card>
                ...
                <Card.Body>
                  <Card.Title>
                    El Juanse - <span className="type">User</span>
                  </Card.Title>
                  <Card.Text>
                    <div className="title">
                      <div className="subTitle"> location</div>San Francisco, CA
                    </div>
                    <div className="title">
                    ...
                    <div className="title">
                      <div className="subTitle">Date: </div>2/06/2020
                    </div>
                  </Card.Text>
                </Card.Body>
                <Card.Footer>
            ...
            <Col xs={4}>
              <Card>
                ...
                <Card.Body>
                  ...
                  <Card.Text> resultrados.</Card.Text>
                </Card.Body>
              </Card>
            </Col>
          </CardDeck>
